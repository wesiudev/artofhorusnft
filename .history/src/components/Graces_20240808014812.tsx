...
dracoLoader.setDecoderPath("/graces.glb");
...
function Grace({
  ...
  const gltf = useLoader(GLTFLoader, "/graces.glb");
...
export default function Graces() {
  ...
  const posX = useTransform(scrollYProgress, [0.1, 0.3], [0, 0]);
  const posY = useTransform(scrollYProgress, [0.1, 0.7, 1], [1, 0, -8]);
  const posZ = useTransform(scrollYProgress, [0.1, 0.5], [1, 2.8]);
